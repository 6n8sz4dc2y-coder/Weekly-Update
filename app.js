...
function build(){
 ...
 makeTable('q3Table',[{label:'Centre',key:'centre'},{label:'Jul Total',key:'jul_total',num:true},{label:'Jul Variance',value:r=>(Number(r.jul_total)||0)-(Number(r.jul_target)||0),format:'variance',num:true},{label:'Aug Total',key:'aug_total',num:true},{label:'Aug Variance',value:r=>(Number(r.aug_total)||0)-(Number(r.aug_target)||0),format:'variance',num:true},{label:'Sep Total',key:'sep_total',num:true},{label:'Sep Variance',value:r=>(Number(r.sep_total)||0)-(Number(r.sep_target)||0),format:'variance',num:true},{label:'QTR Total',key:'qtr_total',num:true},{label:'QTR Variance',value:r=>(Number(r.qtr_total)||0)-(Number(r.qtr_target)||0),format:'variance',num:true},{label:'Status',value:r=>paceRatio(r.qtr_total,r.qtr_target),format:'paceStatus'}],DATA.q3_regs);
 document.getElementById('q3Table')?.classList.add('table-tight');
 makeTable('usedTable',[{label:'Centre',key:'centre'},{label:'Jul Used',key:'jul_counting',num:true},{label:'Jul Variance',value:r=>(Number(r.jul_counting)||0)-(Number(r.jul_target)||0),format:'variance',num:true},{label:'Aug Used',key:'aug_counting',num:true},{label:'Aug Variance',value:r=>(Number(r.aug_counting)||0)-(Number(r.aug_target)||0),format:'variance',num:true},{label:'Sep Used',key:'sep_counting',num:true},{label:'Sep Variance',value:r=>(Number(r.sep_counting)||0)-(Number(r.sep_target)||0),format:'variance',num:true},{label:'QTR Used',key:'qtr_counting',num:true},{label:'QTR Variance',value:r=>(Number(r.qtr_counting)||0)-(Number(r.qtr_target)||0),format:'variance',num:true},{label:'Status',value:r=>usedForecastPct(r),format:'paceStatus'}],DATA.q3_used);
 document.getElementById('usedTable')?.classList.add('table-tight');
 ...
 makeTable('orderBankTable',[{label:'Centre',key:'centre'},{label:'H1 Orders',key:'h1_orders',num:true},{label:'H1 Diff',key:'h1_diff',format:'variance',num:true},{label:'H2 Target',key:'h2_target',num:true},{label:obMonthLabel+' Done',value:r=>orderDoneFor(r,obMonth),num:true},{label:obMonthLabel+' Variance',value:r=>orderDoneFor(r,obMonth)-(Number(r[obTargetKey])||0),format:'variance',num:true},{label:'Q3 Target',key:'q3_target',num:true},{label:'Q4 Target',key:'q4_target',num:true},{label:'CY26 OB',key:'cy26_target',num:true}],(DATA.dashboard_orders||[]).slice().sort((a,b)=>orderDoneFor(b,currentOrderMonth())-orderDoneFor(a,currentOrderMonth())));
 document.getElementById('orderBankTable')?.classList.add('table-tight');
 makeTable('monthlyOrderTable',[
  {label:'Centre',key:'centre'},
  {label:'Jul Done',value:r=>orderDoneFor(r,'jul'),num:true},{label:'Jul Diff',key:'jul_diff',format:'variance',num:true},
  {label:'Aug Done',value:r=>orderDoneFor(r,'aug'),num:true},{label:'Aug Diff',key:'aug_diff',format:'variance',num:true},
  {label:'Sep Done',value:r=>orderDoneFor(r,'sep'),num:true},{label:'Sep Diff',key:'sep_diff',format:'variance',num:true},
  {label:'Oct Done',value:r=>orderDoneFor(r,'oct'),num:true},{label:'Oct Diff',key:'oct_diff',format:'variance',num:true},
  {label:'Nov Done',value:r=>orderDoneFor(r,'nov'),num:true},{label:'Nov Diff',key:'nov_diff',format:'variance',num:true},
  {label:'Dec Done',value:r=>orderDoneFor(r,'dec'),num:true},{label:'Dec Diff',key:'dec_diff',format:'variance',num:true}
],(DATA.dashboard_orders||[]).slice().sort((a,b)=>orderDoneFor(b,currentOrderMonth())-orderDoneFor(a,currentOrderMonth())));
 document.getElementById('monthlyOrderTable')?.classList.add('table-tight');
