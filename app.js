...
function build(){
 ...
 makeTable('fleetTable',[{label:'Centre',key:'centre'},{label:'Regs',key:'regs',num:true},{label:'Target',key:'target',num:true},{label:'Progress',value:r=>r.target?(r.regs+(r.active_orders||0))/r.target:0,format:'progress'},{label:'%',value:r=>r.target?(r.regs+(r.active_orders||0))/r.target:0,format:'pct',num:true},{label:'Active Orders',key:'active_orders',num:true},{label:'Status',value:r=>r.target?(r.regs+(r.active_orders||0))/r.target:0,format:'status'}],DATA.q3_fleet);
